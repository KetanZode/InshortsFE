...
function HolderTile({data}) {
    return (
        <div>
            <div>
                    <div  className='lg:flex justify-between lg:my-8 lg:mx-72 shadow-md shadow-blue-200 m-10  shadow-gray-400 min-h-72 rounded-lg transition-all duration-700 ease-in-out delay-200'>
